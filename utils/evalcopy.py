...
parser.add_argument("--log_dir",default=None, help="where to store the model")
parser.add_argument("--EvalSize",default=None, type=int, help="where to store the model")
parser.add_argument("--exefile",default=None, type=str, help="where to store the model")
...
corpus_max_size = int(EvalSize)*1000 if EvalSize is not None else 0
...
ir_evaluator(model)
json_object=""
with open(args.log_dir+"/sample.jjson", "w") as outfile:
